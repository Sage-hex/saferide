...
//   const [center] = useState({ lat: 6.5244, lng: 3.3792 }); // Lagos, Nigeria
...
//                   <LoadScript googleMapsApiKey="YOUR_GOOGLE_MAPS_API_KEY"> {/* Replace with a valid API key */}
//                     <GoogleMap
...
{isLoaded && (
  <GoogleMap
    ...
    onClick={handleMapClick}
  >
    {selectedLocations.origin && <Marker position={selectedLocations.origin} label="A" />}
    {selectedLocations.destination && <Marker position={selectedLocations.destination} label="B" />}
    {directions && (
      <DirectionsRenderer
        directions={directions}
        options={{
